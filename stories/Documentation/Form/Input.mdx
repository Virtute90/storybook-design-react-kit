...
import { Input, Callout, CalloutText, CalloutTitle } from "../../Components/Form/Input.stories";
...
<div className="docs">
    <Callout color="warning">
        ...
        <CalloutText>Al momento non è ancora disponibili la funzionalità di "password strength" in questo Design React Kit.</CalloutText>
    </Callout>
</div>
