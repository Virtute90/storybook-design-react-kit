...
import * as StepperNavigationDarkStories from '../Components/Stepper/Stepper.Navigation.dark.stories';
...
<div className="docs">
    <Callout color="danger">
        ...
        <CalloutText>
            L’aspetto della modalità mobile degli Steppers è differente rispetto a quello desktop. Se si sta consultando questa documentazione su un PC desktop,
            per visualizzare correttamente gli esempi seguenti in formato mobile sarà necessario ridimensionare la finestra del browser al di sotto dei 992
            pixel.
        </CalloutText>
    </Callout>
</div>
...
<Canvas of={StepperStories.TextOnly}></Canvas>

### Testo e icone

Le label presenti negli step dell'intestazione possono essere anticipate da un'icona.

<Canvas of={StepperStories.TextAndIcons}></Canvas>
...
<Canvas of={StepperStories.OrderOfTheSteps}></Canvas>
...
<Canvas of={StepperStories.NavigationOfTheSteps}></Canvas>
...
<Canvas of={StepperNavigationStories.ProgressBar}></Canvas>
...
<Canvas of={StepperNavigationStories.Pallini}></Canvas>
...
<Canvas of={StepperNavigationStories.SaveButton}></Canvas>
...
<Canvas of={StepperNavigationStories.ConfirmButton}></Canvas>
...
<Canvas of={StepperStories.VersionOnADarkBackground}></Canvas>

### Varianti intestazione

<Canvas of={StepperStories.HeaderVariants}></Canvas>
...
<Canvas of={StepperNavigationDarkStories.ProgressBarDark}></Canvas>

### Pallini

<Canvas of={StepperNavigationDarkStories.PalliniDark}></Canvas>

### Pulsante salva

<Canvas of={StepperNavigationDarkStories.SaveButtonDark}></Canvas>

### Pulsante conferma

<Canvas of={StepperNavigationDarkStories.ConfirmButtonDark}></Canvas>
