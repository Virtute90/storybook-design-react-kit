...
<Canvas of={ToolbarStories.Esempio}></Canvas>
...
<Canvas of={ToolbarStories.EsempioMedium}></Canvas>
...
<Canvas of={ToolbarStories.EsempioSmall}></Canvas>
...
<Canvas of={ToolbarStories.EsempioWithDivider}></Canvas>
...
<Canvas of={ToolbarStories.EsempioConBadgeGrande}></Canvas>
...
<Canvas of={ToolbarStories.EsempioConBadgeMedio}></Canvas>
...
<Canvas of={ToolbarStories.EsempioConBadgePiccolo}></Canvas>
...
<Canvas of={ToolbarStories.EsempioConDropdownGrande}></Canvas>

### Medio con Dropdown

<Canvas of={ToolbarStories.EsempioConDropdownMedia}></Canvas>

### Piccolo con Dropdown

<Canvas of={ToolbarStories.EsempioConDropdownPiccola}></Canvas>
...
<Canvas of={ToolbarStories.EsempioVerticaleGrande}></Canvas>

### Medio verticale

<Canvas of={ToolbarStories.EsempioVerticaleMedia}></Canvas>

### Piccolo verticale

<Canvas of={ToolbarStories.EsempioVerticalePiccola}></Canvas>
