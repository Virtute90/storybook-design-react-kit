...
<Canvas of={TablesStories.TableCaptions}></Canvas>
...
<div className="docs">
  <Callout color="primary">
    <CalloutText>
      ...
      <code>max-</code> e viewports con larghezze frazionarie (che possono verificarsi
      in determinate condizioni su dispositivi ad alta risoluzione, ad esempio) utilizzando
...
<Canvas of={TablesStories.TableResponsive}></Canvas>
...
<Canvas of={TablesStories.TableBreakpoint}></Canvas>
