...
<Canvas of={ProgressStories.ProgressoIndeterminato}></Canvas>
...
<Canvas of={ProgressStories.Colori}></Canvas>
...
<Canvas of={ProgressStories.BottoneConProgressBar}></Canvas>
...
<Canvas of={SpinnerStories.Esempio}></Canvas>

### Spinner doppio

Aggiungendo l'attributo `double` allo `Spinner` si ottiene un’animazione alternativa.

<Canvas of={SpinnerStories.SpinnerDoppio}></Canvas>
