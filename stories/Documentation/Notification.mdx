...
import { NotificationManager, Callout, CalloutTitle, CalloutText } from "../Components/Notification.stories";
import { NotifyFakeComponent_story_hidden, NotifyFakeOptionsComponent_story_hidden } from "../Components/Notification.stories";
...
<div className="docs">
    <Callout color="warning">
        ...
        <CalloutText>
            Di seguito verrà utilizzato un componente <Code>NotificationDoc</Code>, di tipo statico, creato appositamente per lo scopo di questa documentazione
            e <strong>che non deve essere utilizzato</strong> nel codice ai fini di produzione.
        </CalloutText>
    </Callout>
</div>
