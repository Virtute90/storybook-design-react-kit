...
<Canvas of={LinkListStories._Esempi}></Canvas>
...
<Canvas of={LinkListStories._StatoAttivo}></Canvas>
...
<Canvas of={LinkListStories._StatoDisabilitato}></Canvas>
...
<Canvas of={LinkListStories.HeaderEDividerNoLink}></Canvas>

#### Header con link

<Canvas of={LinkListStories.HeaderEDividerConLink}></Canvas>
...
<Canvas of={LinkListStories.Sizing}></Canvas>
...
<Canvas of={LinkListStories.EsempioMultiline}></Canvas>
...
<Canvas of={LinkListStories.ConAvatar}></Canvas>
...
<Canvas of={LinkListStories.ControlliComponent}></Canvas>
...
<Canvas of={LinkListStories.ControlliSecondariComponent}></Canvas>
...
<Canvas of={LinkListStories.PrimaryESecondaryAction}></Canvas>
...
<Canvas of={LinkListStories.CollapseExample}></Canvas>

### Switch e Checkbox
Un `LinkList` può contenere anche elementi form, di seguito un esempio contenente uno switch generato da un `<Toggle>`.

<Canvas of={LinkListStories.ConSwitch}></Canvas>

<Canvas of={LinkListStories.ConCheckbox}></Canvas>
...
<Canvas of={LinkListStories.NavigationComponentFixed}></Canvas>
