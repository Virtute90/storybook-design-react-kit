...
<Controls of={AlertStories._EsempiInterattivi} />
...
<Canvas of={AlertStories.ChiusuraControllata} source={{ code: `
...
<div>
    <Alert {...args} isOpen={open} toggle={closeAlert}>
        <strong>Attenzione</strong>Alcuni campi inseriti s ono da controllare.
    </Alert>
</div>
);` }} />
