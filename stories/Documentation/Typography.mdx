...
<Canvas of={TypographyStories.Titillium}></Canvas>
...
<Canvas of={TypographyStories.Lora}></Canvas>
...
<Canvas of={TypographyStories.RobotoMono}></Canvas>
...
<Canvas of={TypographyStories.Intestazioni}></Canvas>

Queste le dimensioni nel dettaglio:

<Canvas of={TypographyStories.Dimensioni}></Canvas>
...
<Canvas of={TypographyStories.IntestazioneTipo}></Canvas>
...
<Canvas of={TypographyStories.IntestazioneSecondario}></Canvas>
...
<Canvas of={TypographyStories.Paragrafo}></Canvas>
...
<Canvas of={TypographyStories.ParagrafoEvidenza}></Canvas>
...
<Canvas of={TypographyStories.ParagrafiPersonalizzati}></Canvas>
...
<div className="docs">
    <Callout color="success">
        ...
        <CalloutText>
            È fondamentale evidenziare i link presenti in un paragrafo in modo adeguato, utilizzando la forma (grassetto, sottolineato) oltre al colore per
            indicare la presenza di un collegamento ipertestuale.
        </CalloutText>
    </Callout>
</div>
...
<Canvas of={TypographyStories.Link}></Canvas>
...
<Canvas of={TypographyStories.Abbrevazioni}></Canvas>
...
<Canvas of={TypographyStories.Liste}></Canvas>
...
<Canvas of={TypographyStories.ListeInline}></Canvas>
...
<Canvas of={TypographyStories.ListeAllineate}></Canvas>
