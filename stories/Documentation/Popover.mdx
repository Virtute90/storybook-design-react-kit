...
import {
    ...
    CalloutTitle,
    CalloutText,
} from "../Components/Popover.stories";
...
<div className="docs">
    <Callout color="success">
        ...
        <CalloutText>
            I popover funzionano sia con la tastiera che per gli utenti dotati di tecnologia assistiva. Allo stesso modo di quanto avviene per i{" "}
