import React, { AnchorHTMLAttributes, ElementType, FC, HTMLAttributes, ReactNode, Ref } from "react";
...
export const Badge: FC<BadgeProps> = ({ color = "secondary", pill = false, tag = "span", children, testId, ...attributes }) => {
    return (
